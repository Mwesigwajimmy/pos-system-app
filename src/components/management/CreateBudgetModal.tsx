...
import { useForm, useFieldArray, Controller, Resolver } from 'react-hook-form'; // Import Resolver
...
import { Account } from '@/components/ledger/CreateJournalEntryModal'; // Re-use this type if available
...
export function CreateBudgetModal({ accounts }: { accounts: Account[] }) {
    ...
    // FIX: Cast the resolver output to Resolver<FormData> to resolve the complex type conflict.
