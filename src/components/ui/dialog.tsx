...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        // z-[200]: above the app shell's fixed chrome (Sidebar is z-[150],
        // the mobile hamburger is z-[160]) so dialogs always sit on top of it.
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // Matches DialogOverlay's z-[200] — see the note there.
