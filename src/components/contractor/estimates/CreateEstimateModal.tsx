...
import { createEstimate, FormState } from '@/lib/contractor/actions/estimates';
...
export function CreateEstimateModal() {
    ...
    const [formState, formAction] = useFormState(createEstimate, initialState);
            ...
            <DialogContent className="sm:max-w-[500px]">
                <form action={formAction}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Enter the initial details for this quote. You can add line items in the next step.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    <div className="grid gap-4 py-6">
                        <div className="space-y-1">
                            ...
                            <Input id="title" name="title" placeholder="e.g., 123 Main St. Kitchen Remodel" required />
