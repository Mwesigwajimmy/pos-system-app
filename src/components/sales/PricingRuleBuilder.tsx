...
export function PricingRuleBuilder({ 
    ...
    // FIXED SUBMIT LOGIC TO MATCH PRICING.TS HANDSHAKE
    ...
    return (
        <form onSubmit={handleSubmit(onActualSubmit)} className="w-full max-w-[1600px] mx-auto p-4 md:p-8 lg:p-12 space-y-8 bg-[#f8fafc]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                {/* TAB 2: CONDITIONS (FIXED OVERLAP HERE) */}
                                                    ...
                                                    <div className="md:col-span-4 space-y-2">
                                                        ...
                                                        <Controller control={control} name={`conditions.${index}.target_id`} render={({ field: targetField }) => (
                                                            <Select onValueChange={targetField.onChange} value={targetField.value}>
                                                                {/* FIXED: min-w added to prevent trigger collapse and overlapping */}
                ...
                {/* SIDEBAR: TELEMETRY & PREVIEW (ALL PRESERVED) */}
