...
export default async function AdminLayout({ children }: AdminLayoutProps) {
  ...
  // 3. Authority Check: Fetching Profile from DB (Untouched Logic)
  ...
  const role = (profile.system_access_role?.toLowerCase() || 'architect') as SovereignRole;
  ...
  return (
    <div className="flex h-screen bg-[#f8fafc] text-slate-900 overflow-hidden font-sans">
      ...
      {/* SIDEBAR INJECTION: Clean White Admin Navigation */}
