        ...
        <div className="space-y-10 max-w-5xl mx-auto pb-20">
          ...
          {!identityIsAnchored && (
            <div className="text-center py-48 animate-in fade-in zoom-in duration-700">
                ...
                <h2 className="text-2xl font-bold text-slate-800 uppercase tracking-[0.4em]">Preparing Secure Audit</h2>
                <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.6em] mt-4">
      ...
      <footer className="border-t bg-white p-10 shadow-[0_-25px_80px_rgba(0,0,0,0.05)] relative z-20">
        ...
        <div className="flex items-center justify-between mt-7 max-w-6xl mx-auto px-2">
            ...
            <div className="text-[9px] font-black uppercase text-slate-300 tracking-[0.3em] text-right leading-tight opacity-80">
                Isolated Executive Environment<br/>Business Access Protocol • Nak Business
            </div>
        </div>
      </footer>
    </div>
