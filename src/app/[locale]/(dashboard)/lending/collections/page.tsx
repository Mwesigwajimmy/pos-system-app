...
import { CollectionsManager } from '@/components/lending/CollectionsManager';
...
async function fetchUserContext() {
    ...
    // In collections, we might also check if the user has the 'collections_agent' role
...
export default function CollectionsPage() {
    ...
    return (
        <div className="p-8 space-y-6">
            <CollectionsManager tenantId={tenantId} />
        </div>
    );
}