...
// --- CRITICAL FIX: Import the Provider ---
...
export default async function AiAuditAssistantPage({
    ...
    return (
        // Wrap the entire UI in the GlobalCopilotProvider to satisfy the context requirements of AiAuditAssistant
        <GlobalCopilotProvider>
            <div className="flex-1 space-y-6 p-4 md:p-8 pt-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                {/* AI Assistant Core Interface - Now safely wrapped in its Provider */}
