...
const publicPaths = [
    ...
    '/newsletter', '/help-centre', '/download', '/store', '/marketplace', '/features'
];
...
const rolePermissions: Record<string, string[]> = {
    ...
    '/agri': ['admin', 'manager', 'owner', 'architect', 'commander', 'accountant', 'auditor', 'farm_manager', 'veterinary_officer'],
